...
public class base {
	...
	public void initializeDriver() throws IOException
	{
		...
		//where we want a method to set the driver based on the browser type. We want to pass a browser name into this meathod and in turn it will set up the proper driver. 
