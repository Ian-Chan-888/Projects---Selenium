...
public class S19_Lesson151_zz_ALTERNATE {
	/*
	...
	public void listdata()
	{
		...
		System.out.println("Your Test URL is = " + prop.getProperty("url"));
		System.out.println("Your Firefox driver location is    = " + prop.getProperty("Firefox_driver_location"));
		System.out.println("Your Chrome driver location is     = " + prop.getProperty("Chrome_driver_location"));
		System.out.println("Your Internet Explorer location is = " + prop.getProperty("InternetExplorer_driver_location"));
