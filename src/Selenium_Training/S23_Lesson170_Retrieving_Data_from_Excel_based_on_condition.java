...
public class S23_Lesson170_Retrieving_Data_from_Excel_based_on_condition {
	/*
		...
		//getting access to the excel document
				...
				for (int i=0;i<sheets;i++)
				{
					...
					if (workbook.getSheetName(i).equalsIgnoreCase("testdata"))//looking for the sheet labled 'testdata'
					{
						...
						Iterator<Row> rows = sheet.iterator();  //import java.util.Iterator; and import org.apache.poi.ss.usermodel.Row; // sheet is a collection of rows
